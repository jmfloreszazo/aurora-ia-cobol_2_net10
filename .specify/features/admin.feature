Feature: User Administration
  ...
  Scenario: View list of all users
    ...
    And I should see user "USER0001" with role "USER"
  ...
  Scenario: Validate user ID is unique
    When I attempt to create a user with ID "USER0001"
  ...
  Scenario: Update user information
    Given I am viewing user "USER0001" details
  ...
  Scenario: Password confirmation must match
    When I am changing password for user "USER0001"
  ...
  Scenario: Search users by name
    ...
    And the results should include "USER0001"
  ...
  Scenario: View user activity log
    Given user "USER0001" has recent login activity
    When I view user "USER0001" details
  ...
  Scenario: Reset user password (admin-initiated)
    Given user "USER0001" forgot their password
    When I view user "USER0001" details
  ...
  Scenario: Unlock locked user account
    Given user "USER0001" is locked due to failed login attempts
    When I view user "USER0001" details
